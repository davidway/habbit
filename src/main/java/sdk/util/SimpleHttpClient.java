...
public class SimpleHttpClient {
	...
	private static Log logger = LogFactory.getLog(SimpleHttpClient.class);
	...
	public String post(String url, String reqBodyJson) throws RuntimeException {
		try {
	...
	protected CloseableHttpClient getConnection() {
